<template>
    ...
    <hr>
    <div class="d-flex flex-column p-3 h-75">
        <textarea placeholder="Qué sucedio hoy?"></textarea>
    </div>
    <Fab
        icon="fa-save"
    />
    <img src="https://www.dzoom.org.es/wp-content/uploads/2017/07/seebensee-2384369-810x540.jpg" alt="entry-picture" class="img-thumbnail">
</template>
